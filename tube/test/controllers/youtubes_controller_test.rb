...
class YoutubesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create youtube" do
    assert_difference('Youtube.count') do
      post youtubes_url, params: { youtube: { description: @youtube.description, thumbnail: @youtube.thumbnail, title: @youtube.title, video_file: @youtube.video_file } }
    end
  ...
  test "should update youtube" do
    patch youtube_url(@youtube), params: { youtube: { description: @youtube.description, thumbnail: @youtube.thumbnail, title: @youtube.title, video_file: @youtube.video_file } }
